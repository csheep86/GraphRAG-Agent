...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-x-auto scrollbar-subtle"
    >
      <table
        data-slot="table"
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-11 px-5 text-left align-middle text-xs font-normal whitespace-nowrap text-muted-foreground",
        className,
      )}
      {...props}
    />
